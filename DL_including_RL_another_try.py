...
def DL_process(DL_database):
    ...
    saver.save(sess,'relative_network_another/test.ckpt')    
    return
...
if __name__ == '__main__':
    ...
    sess.run(init)   
    saver.restore(sess,'relative_network_another/test.ckpt')
    ...
    for i in range(10):
        ...
        if i != 0:
            ...
            Test_process(LAST_SAVE_PATH + '/training_record/Collussion.json', RL_SAVE_PATH, 0.1)
